...
export const getColumns = (
    {onDelete,clientUpdateContext}: {onDelete:(id: string) => void,clientUpdateContext:contextClient}
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="max-w-[200px]">
          <span className="text-gray-600 text-sm truncate block" title={address}>
            {address}
          </span>
        </div>
      );
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleUpdate = () => {
          const {changeClient,changeOpen}=clientUpdateContext;
          changeClient(null)
          changeClient(client)
          changeOpen(true)
      };
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem
                ...
                className="px-3 py-2 text-sm text-green-600 hover:bg-red-50 cursor-pointer rounded-md flex items-center gap-2 transition-colors"
              >
